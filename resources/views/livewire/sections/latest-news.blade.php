            ...
            <div
                ...
                @foreach ($news as $new)
                    <article data-aos="fade-up" data-aos-duration="1500"
                        ...
                        <a href="{{ $new->link }}{{ $new->id }}" class="absolute inset-0 z-10">
                            <span class="sr-only">
                                {{-- Go to {{ $new->title }} --}}
                            </span>
                        </a>
                        ...
                        <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm leading-6 text-white">
                            <time datetime="{{ $new->created_at->format('Y-m-d') }}"
                                class="text-white mr-6">{{ $new->created_at->format('M d, Y') }}</time>
                        ...
                        <h3 class="mt-1 text-sm font-normal leading-6 text-white">
                            <a href="{{ route('videos.show', $new->id) }}">
                        ...
                        <div class="mt-2">
                            <button wire:click=""
                                class="text-white bg-{{ $new->is_featured ? 'yellow' : '' }}-500 hover:bg-{{ $new->is_featured ? 'yellow' : '' }}-700 font-bold py-2 px-4 rounded">
