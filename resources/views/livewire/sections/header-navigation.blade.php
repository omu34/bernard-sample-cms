                    ...
                    @foreach ($items as $item)
                        @if ($item->link)
                            <a href="{{ $item->link }}" target='_blank' {{ $item->name }}
                                class="text-base hover:underline hover:underline-offset-4 font-normal leading-6 text-black dark:text-white">
                            </a>
                        @endif
                    @endforeach
                @endif
    ...
    <div :class="{ 'shadow-2xl bg-white dark:bg-slate-950': isSticky }">
        <nav :class="isSticky ? 'mt-0 px-0' : 'mt-6 px-10 '"
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <a href="/single-media"
                    class="text-base dark:text-white hover:underline hover:underline-offset-4 font-normal text-black">News</a>
                {{--   <a href="#"
                    class="text-base dark:text-white hover:underline hover:underline-offset-4 font-normal text-black">Company</a>  --}}

                @if ($selectedNavbar == 'main')
                    @foreach ($items as $item)
                        @if ($item->link)
                            <a href="{{ $item->link }}" target='_blank' {{ $item->name }}
                                class="text-base hover:underline hover:underline-offset-4 font-normal leading-6 text-white">
                            </a>
                        @endif
                    @endforeach
                @endif
