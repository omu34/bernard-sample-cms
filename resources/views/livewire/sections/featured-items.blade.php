<div class="bg-white bg-center py-12 sm:py-16">
    <div class="mx-auto lg:px-0 px-10 max-w-7xl">
      <div class="mx-auto flex flex-col items-center sm:flex-row sm:justify-between ">
        <h2 class="text-3xl font-bold tracking-tight lg:pb-0 pb-5 text-gray-900 sm:text-3xl">Trending</h2>
      </div>
        ...
        @foreach ($currentItems as $currentItem)
          <article data-aos="fade-up" data-aos-duration="1500"
            ...
            @if ($currentItem instanceof \App\Models\LatestVideos)
              <img src="/video.png"
                class="absolute text-yellow top
  -2/3 mb-8 left-1/2 transform -translate-x-1/2 -translate-y-28 h-12 w-12 fill-white"
                            alt="">
